...
public class moimMemberDTO {
	...
	public int getMoimMemberNum() {
		return moimMemberNum;
	}
	public void setMoimMemberNum(int moimMemberNum) {
		this.moimMemberNum = moimMemberNum;
	}
