...
// DB검색하여 결과 리턴 받기
	...
	<div class="myGatherWrap">
		...
		<%}%>
		<div class="myGather">
			<span class="mouseHand" onclick="location.href='#'">문정동 아이파크 공원 저녁 산책 모임모임오미오미</span>
			<span>다음모임 : 8/14(수) 20:00</span>
			<span>3개의 새글이 올라 왔습니다.</span>
		</div>		
	</div>
	...
	<div>
		<a href="moimMaking.ne" class="btn320_55 gatherMake">소모임 만들기</a>
	</div>
