...
<header class="header">		
	<div class="headerWrap">
		...
		<nav class="headLeft">
			<ul>	
				<li><a href="timeLine.ti?<%-- userId=<%=userId%>&userNickname=<%=userNickname%>&userPhoto=<%=userPhoto%> --%>"><span id="seeAll">타임라인</span></a></li>				
...
<%	if(userId==null){// 세션값이 없으면 %>
	...
	<nav class="headRight">
			...
			<a href="./mypage.me" style="background-image: url('<%=userPhoto%>');" class="profilePhoto35"></a>
